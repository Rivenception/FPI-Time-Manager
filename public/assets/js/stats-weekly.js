...
fetch("/api/timesheets/tasks/eng/weekly")
    .then(response => {
        return response.json();
    })
    .then(data => {
        // console.log(data)
        populateChartWeekly(data);
    });
...
function populateChartWeekly(data) {
    ...
    // let line = document.querySelector("#canvas-weekly").getContext("2d");
    let barCategories = document.querySelector("#canvas5-weekly").getContext("2d");
    let barTasks = document.querySelector("#canvas2-weekly").getContext("2d");
    let pie = document.querySelector("#canvas3-weekly").getContext("2d");
    let pie2 = document.querySelector("#canvas4-weekly").getContext("2d");
