...
fetch("/api/timesheets/tasks/eng/monthly")
    .then(response => {
...
function populateChartMonthly(data) {
    ...
    // let line = document.querySelector("#canvas-monthly").getContext("2d");
    let barCategories = document.querySelector("#canvas7-monthly").getContext("2d");
    let barTasks = document.querySelector("#canvas8-monthly").getContext("2d");
    let pie = document.querySelector("#canvas9-monthly").getContext("2d");
    let pie2 = document.querySelector("#canvas10-monthly").getContext("2d");
